...
flags.DEFINE_integer('hierarchy', 2, "The degree of hierarchical classes.")
flags.DEFINE_integer('ko_threshold', 1600, "The threshold of kos which are thought the long tails.")
flags.DEFINE_integer('ko_threshold2', 100, "The threshold of kos which are thought the long tails.")
